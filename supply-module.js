...
(function () {
  ...
  function initCarousel() {
    ...
    function showSlide(slideNum) {
      ...
      var activeSlide = document.querySelector('[data-slide="' + slideNum + '"]');
      if (activeSlide) {
    ...
    var carousel = document.querySelector('.supply-carousel');
    if (carousel) {
      carousel.addEventListener('click', function (e) {
        // Only navigate if clicking on the carousel area, not on actual interactive elements
    ...
    // Ensure initial state is correct even if HTML changes
    showSlide(1);
  }
  ...
  function initCharts() {
    ...
    supplyData.graphs.forEach(function (graphData) {
      // Update title in DOM if it exists
  ...
  // Expose update function for admin panel
